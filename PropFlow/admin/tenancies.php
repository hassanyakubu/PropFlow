...
<body class="font-sans text-gray-800 antialiased min-h-screen flex flex-col bg-gray-50 dark:bg-slate-900 transition-colors duration-300">
    ...
    <div class="flex flex-col md:flex-row flex-grow container mx-auto px-4 py-8 gap-8">
        ...
        <main class="flex-grow">
            ...
            <?php if (isset($_GET['msg']) && $_GET['msg'] === 'tenancy_ended'): ?>
                <div
                    ...
                    <p class="font-medium">Tenancy successfully ended by Admin.</p>
                </div>
            <?php endif; ?>
            <?php if (isset($_GET['error'])): ?>
                <div
                    ...
                    <p class="font-medium">Error performing action. Please try again.</p>
                </div>
            <?php endif; ?>
            ...
            <div id="endTenancyModal" class="modal"
                ...
                <div class="modal-content"
                    ...
                    <h2 class="text-xl font-bold mb-4 text-red-600">Force End Tenancy</h2>
                    <p class="mb-4 text-gray-700">Are you sure you want to end this tenancy? The tenant will be notified and the property will become available for new applications. This is an administrative override.</p>
