    ...
    <div class="flex flex-col md:flex-row flex-grow container mx-auto px-4 py-8 gap-8">
        ...
        <main class="flex-grow">
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger"
                                                onclick="showRejectModal(<?php echo $app['application_id']; ?>, '<?php echo htmlspecialchars($app['property_title']); ?>', '<?php echo htmlspecialchars($app['full_name']); ?>')">Decline</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
            ...
            <div id="rejectModal" class="modal"
                ...
                <div class="modal-content"
                    style="background:white; margin:10% auto; padding:20px; width:50%; border-radius:8px;">
                    <h2 class="text-xl font-bold mb-4 text-red-600">Decline Application</h2>
                    <p id="rejectModalText" class="mb-4 text-gray-700"></p>
                    <form action="../actions/process_application_action.php" method="POST">
            ...
            <script>
                ...
                function showRejectModal(id, title, tenant) {
                    document.getElementById('rejectModalAppId').value = id;
                    document.getElementById('rejectModalText').innerText = 'Are you sure you want to decline the application from ' + tenant + ' for ' + title + '?';
